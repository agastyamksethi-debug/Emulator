...
_TYPE_TO_LIB_ID: dict[str, str] = {
    ...
    "photoresistor":   "Device:R_Photo",
    "ldr":             "Device:R_Photo",
    # extended part library
    "ntc":             "Device:Thermistor_NTC",
    "thermistor":      "Device:Thermistor_NTC",
    "tmp36":           "Device:TMP36",
    "ir_led":          "Device:LED_IR",
    "ir_receiver":     "Device:IR_Receiver",
    "photodiode":      "Device:Photodiode",
    "pir":             "Device:PIR",
    "microphone":      "Device:Microphone",
    "sound_sensor":    "Device:Microphone",
    "hall":            "Device:Hall",
    "fsr":             "Device:FSR",
    "reed":            "Device:Reed",
    "reed_switch":     "Device:Reed",
    "buzzer":          "Device:Buzzer",
    "relay":           "Device:Relay",
    "servo":           "Device:Servo",
    "dc_motor":        "Device:Motor_DC",
    "motor":           "Device:Motor_DC",
